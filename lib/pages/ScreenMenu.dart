...
class ScreenMenuWidget extends StatefulWidget {
  
  @override
  _DrawerWidgetState createState() => new _DrawerWidgetState();
}

class _DrawerWidgetState extends State<ScreenMenuWidget> {
                          ...
                          child: Container(
                            ...
                            child: Column(children: <Widget>[
                              ...
                              Row(children: <Widget>[
                                ...
                                Container(
                                    child: Text(
                                        "Verifique as mensagens em menu> listas> mensagens",
                                        style: TextStyle(
                                            fontSize: 11,
  ...
  List<Widget> RetornaWidgetsEmpresas_(BuildContext context) {
    ...
    try {
      ...
      Text("Inativos:", style: GoogleFonts.mcLaren(fontSize: 16,fontWeight: FontWeight.bold))):Text(""));
